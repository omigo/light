...
type ModelMapper interface {
	...
	// insert into models(name, flag, score, map, time, xarray as array, slice, status, pointer, struct_slice, uint32)
	// values [{ i, m := range ms | , }
	...
	// select id, name, flag, score, map, time, xarray as array, slice, status, pointer, struct_slice, uint32
	// from models
	// where id=${id}
