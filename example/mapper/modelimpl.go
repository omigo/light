...
// It is generated by `light` tool from source `model.go` at 2017-03-22 17:17:12.
...
func (*ModelMapperImpl) Insert(trans *sql.Tx, m *domain.Model) (err error) {
	var (
		xbuf  bytes.Buffer
		xargs []interface{}
	)
...
func (*ModelMapperImpl) BatchInsert(tx *sql.Tx, ms []*domain.Model) (xa int64, err error) {
	var (
		xbuf  bytes.Buffer
		xargs []interface{}
	)
...
func (*ModelMapperImpl) Get(tx *sql.Tx, id int) (xobj *domain.Model, err error) {
	var (
		xbuf  bytes.Buffer
		xargs []interface{}
	)
...
func (*ModelMapperImpl) Update(tx *sql.Tx, m *domain.Model) (xa int64, err error) {
	var (
		xbuf  bytes.Buffer
		xargs []interface{}
	)
...
func (*ModelMapperImpl) Count(tx *sql.Tx, m *domain.Model, ss []enum.Status) (xcnt int64, err error) {
	var (
		xbuf  bytes.Buffer
		xargs []interface{}
	)
...
func (*ModelMapperImpl) List(tx *sql.Tx, m *domain.Model, ss []enum.Status, offset int, limit int) (xdata []*domain.Model, err error) {
	var (
		xbuf  bytes.Buffer
		xargs []interface{}
	)
...
func (*ModelMapperImpl) Page(tx *sql.Tx, m *domain.Model, ss []enum.Status, offset int, limit int) (xcnt int64, xdata []*domain.Model, err error) {
	var (
		xbuf  bytes.Buffer
		xargs []interface{}
	)
